...
export default function Page() {
  ...
  return (
    ...
    //         <div className=' w-[100%] h-[500px] 2xl:flex-row xl:flex-row lg:flex-col md:flex-col sm:flex-col mobile:flex-col flex mb-7 md:h-auto sm:h-auto mobile:h-auto  sm:mb-7 '>
    //             <ul className='h-96 '>
    //                 {left.map((item)=>(
    ...
    //             </ul>
    //         </div>
    //         <div className='bg-slate-800 w-[65%] h-[344px] inline-block'>
            ...
            >
              ...
              {left.map((value, index) => {
                return (
                  <li
                    key={index}
                    className={`${darkMode ? "bg-slate-800": "text-white"} bg-black list-none font-normal text-base  2xl:text-[20px] xl:text-[18px] lg:text-[16px] md:text-[18px] sm:text-[15px] mobile:hidden`}
                    id={index}
                  >
                    {value.name}
                  </li>
